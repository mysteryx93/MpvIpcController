...
namespace HanumanInstitute.MpvIpcController
{
    public class MpvApi : IDisposable
    {
        ...
        /// </summary>
        public async Task<string> GetClientName(MpvCommandOptions? options = null)
        {
            var response = await _mpv.SendMessageAsync(options, "client_name").ConfigureAwait(false);
        ...
        /// </summary>
        public async Task<int> GetClientTime(MpvCommandOptions? options = null)
        {
            var response = await _mpv.SendMessageAsync(options, "get_time_us").ConfigureAwait(false);
        ...
        public async Task<T> GetProperty<T>(string propertyName, MpvCommandOptions? options = null)
            where T : struct
        {
        ...
        /// </summary>
        /// <param name="propertyName">The name of the property to get.</param>
        public async Task<string> GetPropertyString(string propertyName, MpvCommandOptions? options = null)
        {
            propertyName.CheckNotNullOrEmpty(nameof(propertyName));
        ...
        public async Task SetProperty(string propertyName, object value, MpvCommandOptions? options = null)
        {
            propertyName.CheckNotNullOrEmpty(nameof(propertyName));
        ...
        /// <param name="propertyName">The name of the property to set.</param>
        public async Task ObserveProperty(int observeId, string propertyName, MpvCommandOptions? options = null)
        {
            propertyName.CheckNotNullOrEmpty(nameof(propertyName));
        ...
        /// <param name="propertyName">The name of the property to set.</param>
        public async Task ObservePropertyString(int observeId, string propertyName, MpvCommandOptions? options = null)
        {
            propertyName.CheckNotNullOrEmpty(nameof(propertyName));
        ...
        public async Task UnobserveProperty(int observeId, MpvCommandOptions? options = null)
        {
        ...
        public async Task RequestLogMessages(LogLevel logLevel, MpvCommandOptions? options = null)
        {
        ...
        public async Task EnableEvent(string eventName, MpvCommandOptions? options = null)
        {
        ...
        /// </summary>
        /// <param name="eventName">The name of the event to enable.</param>
        public async Task DisableEvent(string eventName, MpvCommandOptions? options = null)
        {
            eventName.CheckNotNullOrEmpty(nameof(eventName));
        ...
        /// </summary>
        public async Task<int> GetVersion(MpvCommandOptions? options = null)
        {
        ...
        /// </summary>
        public async Task IgnoreKeys(MpvCommandOptions? options = null)
        {
        ...
        public async Task Seek(double units, SeekOptions flags, MpvCommandOptions? options = null)
        {
        ...
        public async Task RevertSeek(bool mark, MpvCommandOptions? options = null)
        {
        ...
        /// </summary>
        public async Task FrameStep(MpvCommandOptions? options = null)
        {
        ...
        /// </summary>
        public async Task FrameBackStep(MpvCommandOptions? options = null)
        {
        ...
        public async Task Set(string name, object value, MpvCommandOptions? options = null)
        {
        ...
        public async Task Add(string name, object value, MpvCommandOptions? options = null)
        {
            name.CheckNotNullOrEmpty(nameof(name));
        ...
        /// <returns></returns>
        public async Task Cycle(string name, CycleDirection direction = CycleDirection.Up, MpvCommandOptions? options = null)
        {
            name.CheckNotNullOrEmpty(nameof(name));
        ...
        public async Task Multiply(string name, object value, MpvCommandOptions? options = null)
        {
            name.CheckNotNullOrEmpty(nameof(name));
        ...
        public async Task Screenshot(ScreenshotOptions flags, MpvCommandOptions? options = null)
        {
        ...
        /// <param name="flags">Screenshot options. Multiple flags can be combined.</param>
        public async Task ScreenshotToFile(string fileName, ScreenshotOptions flags, MpvCommandOptions? options = null)
        {
        ...
        public async Task PlaylistNext(bool terminateOnEnd = false, MpvCommandOptions? options = null)
        {
        ...
        public async Task PlaylistPrev(bool terminateOnEnd = false, MpvCommandOptions? options = null)
        {
        ...
        /// <param name="loadOptions">A list of options and values which should be set while the file is playing. Not all options can be changed this way. Some options require a restart of the player.</param>
        public async Task LoadFile(string path, bool append = false, bool appendPlay = false, IDictionary<string, object>? loadOptions = null, MpvCommandOptions? options = null)
        {
            path.CheckNotNullOrEmpty(nameof(path));

            var flag = append ? (appendPlay ? "append-play" : "append") : "replace";
            var args = new object[2 + loadOptions?.Count ?? 0];
            args[0] = path;
            args[1] = flag;
            if (loadOptions != null)
            {
            ...
            await _mpv.SendMessageAsync(options, "loadfile", args).ConfigureAwait(false);
        }
        ...
        public async Task LoadPlaylist(string path, bool append = false, MpvCommandOptions? options = null)
        {
            path.CheckNotNullOrEmpty(nameof(path));
        ...
        /// </summary>
        public async Task PlaylistClear(MpvCommandOptions? options = null)
        {
        ...
        public async Task PlaylistRemove(int index, MpvCommandOptions? options = null)
        {
        ...
        /// </summary>
        /// <param name="index">The index of the playlist entry to remove.</param>
        public async Task PlaylistRemoveCurrent(MpvCommandOptions? options = null)
        {
        ...
        public async Task PlaylistMove(int index, int destIndex, MpvCommandOptions? options = null)
        {
            index.CheckRange(nameof(index), min: 0);
        ...
        /// </summary>
        public async Task PlaylistShuffle(MpvCommandOptions? options = null)
        {
        ...
        /// </summary>
        public async Task PlaylistUnshuffle(MpvCommandOptions? options = null)
        {
        ...
        public async Task RunShell(string command, MpvCommandOptions? options = null)
        {
        ...
        public async Task Quit(int? exitCode = null, MpvCommandOptions? options = null)
        {
        ...
        /// </summary>
        /// <param name="exitCode">The process exit code.</param>
        public async Task QuitWatchLater(int? exitCode = null, MpvCommandOptions? options = null)
        {
        ...
        public async Task SubAdd(string path, LoadOption option = LoadOption.Select, string? title = null, string? lang = null, MpvCommandOptions? options = null)
        {
            path.CheckNotNullOrEmpty(nameof(path));
        ...
        public async Task SubRemove(int? id = null, MpvCommandOptions? options = null)
        {
        ...
        public async Task SubReload(int? id = null, MpvCommandOptions? options = null)
        {
        ...
        public async Task SubStep(int skip, MpvCommandOptions? options = null)
        {
        ...
        /// </summary>
        /// <param name="skip">The amount of subtitle events to move to, forwards or backwards.</param>
        public async Task SubSeek(int skip, MpvCommandOptions? options = null)
        {
        ...
        public async Task PrintText(string text, MpvCommandOptions? options = null)
        {
        ...
        /// <returns></returns>
        public async Task ShowText(string text, int duration, int minOsdLevel, MpvCommandOptions? options = null)
        {
        ...
        /// </summary>
        public async Task ShowProgress(MpvCommandOptions? options = null)
        {
        ...
        /// </summary>
        public async Task WriteWatchLaterConfig(MpvCommandOptions? options = null)
        {
        ...
        /// </summary>
        public async Task Stop(MpvCommandOptions? options = null)
        {
        ...
        /// <returns></returns>
        public async Task Mouse(int x, int y, int? button = null, bool doubleClick = false, MpvCommandOptions? options = null)
        {
        ...
        public async Task KeyPress(string key, MpvCommandOptions? options = null)
        {
        ...
        /// </summary>
        /// <param name="key">The key to send.</param>
        public async Task KeyDown(string key, MpvCommandOptions? options = null)
        {
        ...
        /// </summary>
        /// <param name="key">The key to send.</param>
        public async Task KeyUp(string? key = null, MpvCommandOptions? options = null)
        {
        ...
        public async Task KeyBind(string key, string command, MpvCommandOptions? options = null)
        {
        ...
        /// <param name="title">The track title in the UI.</param>
        /// <param name="lang">The track language. It can influence stream selection when using LoadOption.Auto.</param>
        public async Task AudioAdd(string path, LoadOption option = LoadOption.Select, string? title = null, string? lang = null, MpvCommandOptions? options = null)
        {
            path.CheckNotNullOrEmpty(nameof(path));
            option.CheckEnumValid(nameof(option));
        ...
        public async Task AudioRemove(int? id = null, MpvCommandOptions? options = null)
        {
        ...
        public async Task AudioReload(int? id = null, MpvCommandOptions? options = null)
        {
        ...
        /// <param name="title">The track title in the UI.</param>
        /// <param name="lang">The track language. It can influence stream selection when using LoadOption.Auto.</param>
        public async Task VideoAdd(string path, LoadOption option = LoadOption.Select, string? title = null, string? lang = null, MpvCommandOptions? options = null)
        {
            path.CheckNotNullOrEmpty(nameof(path));
            option.CheckEnumValid(nameof(option));
        ...
        public async Task VideoRemove(int? id = null, MpvCommandOptions? options = null)
        {
        ...
        public async Task VideoReload(int? id = null, MpvCommandOptions? options = null)
        {
        ...
        public async Task RescanExternalFiles(bool reselect = true, MpvCommandOptions? options = null)
        {
