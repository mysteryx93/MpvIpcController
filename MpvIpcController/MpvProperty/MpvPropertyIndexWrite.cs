...
namespace HanumanInstitute.MpvIpcController
{
    ...
    public class MpvPropertyIndexWrite<TIndex, T> : MpvPropertyIndexRead<TIndex, T>
    {
        ...
        public Task SetAsync(TIndex index, T value, ApiOptions? options = null) => Api.SetPropertyAsync(GetPropertyIndexName(index), value, options);
        ...
        public Task AddAsync(TIndex index, T value, ApiOptions? options = null) => Api.AddAsync(GetPropertyIndexName(index), value, options);
        ...
        public Task MultiplyAsync(TIndex index, T value, ApiOptions? options = null) => Api.MultiplyAsync(GetPropertyIndexName(index), value, options);
